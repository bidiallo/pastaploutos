<?php
    $dns = "mysql:host=database-etudiants.iut.univ-paris8.fr;dbname=dutinfopw201618;";
    ...
    $t->execute(array("$mot%","$mot%"));
     ...
     foreach($a as $r){
        echo "<a href=index.php?module=gestionUser&action=consulter_profil&id=$r[id_user]>$r[prenom_user]<a/><br>";
