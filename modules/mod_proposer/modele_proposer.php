...
class ModeleProposer extends ModeleGenerique {
	...
	function modele_proposer($titre_recette, $description_recette, $niv_difficulte_recette, $cout_recette, $is_vegetarien, $nbPersonne_recette, $tpsPreparation_recette, $tpsCuisson_recette, $id_cat){
		//13
		$req = 'INSERT INTO p_recette ($titre_recette, $description_recette, $niv_difficulte_recette, $cout_recette, $is_vegetarien, nbNotes_recette, photo_recette, $nbPersonne_recette, notesTotal_recette, recette_publie, $tpsPreparation_recette, $tpsCuisson_recette, $id_cat) VALUES (?, ?, ?, ?, ?, 0, null, ?, 0, 0, ?, ?, ?);';
