...
class ModeleProposer extends ModeleGenerique {
	...
	function modele_proposer($titre_recette, $description_recette, $niv_difficulte_recette, $cout_recette, $is_vegetarien, $photo_recette, $nbPersonne_recette,$id_ingredient, $tpsPreparation_recette, $tpsCuisson_recette, $id_cat){
		//13
		$req = 'INSERT INTO p_recette (titre_recette, description_recette, niv_difficulte_recette, cout_recette, is_vegetarien, nbNotes_recette, photo_recette, nbPersonne_recette, id_ingredient, recette_publie, tpsPreparation_recette, tpsCuisson_recette, id_cat) VALUES (?, ?, ?, ?, ?, 0, ?, ?, ?, 0, ?, ?, ?);';
