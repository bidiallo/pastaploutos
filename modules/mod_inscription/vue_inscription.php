...
class VueInscription extends VueGenerique{
	...
	function vue_form_inscription(/*askip token*/){
		...
		<div class="container" >
	      ...
	      <form class="form-signin" action ="index.php?module=inscription&action=ajout_inscription" method="post">
	        ...
	        <button style="margin-top:25px; margin-left:50px" type="submit">S'inscrire</button>
	      </form>
